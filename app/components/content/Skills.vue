...
<template>
  <div class="max-w-3xl mx-auto my-8">
    ...
    <div
      class="grid grid-cols-3 border-r border-l border-dashed divide-dashed divide-x divide-indigo-100 mb-2 border-indigo-100"
    >
      <div
      ...
      >
        ...
        <ol class="flex flex-col space-y-2">
          <li
            ...
            :key="index"
            class="relative flex items-center font-light gap-x-2 before:content-['*_'] before:inline-block before:text-md before:h-4 before:text-indigo-200 text-xs"
          >
            {{ item }}
          </li>
        </ol>
